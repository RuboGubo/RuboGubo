...
- [**Clan-Config**](https://gitlab.com/RuboGubo/clan-config) My fully declarative multi-machine server config for with secrets management for automatic project deployment.
